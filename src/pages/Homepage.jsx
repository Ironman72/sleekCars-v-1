      ...
      <div className='container max-w-[1140px] w-screen m-auto flex flex-col-reverse lg:flex-row mt-5 lg:mt-18 gap-12 h-[90vh]  '>
        <div className='flex flex-1 flex-col items-center lg:items-start justify-center  mb-10 md:max-h-[500px] md:w-[500px] mt-5'>
          ...
          <div className='flex justify-center  flex-wrap gap-6 items-center'>
            ...
            <button className='text-slate-500 underline mt-3 lg:mt-5  ml-5'>Explore Cars</button>
          </div>
        </div>
        <div className='flex flex-1 justify-center items-center z-10 md:max-h-[500px] md:w-[500px] mb-[30px] md:mb-12  lg:mb-0 mt-2'>
