...
const Homepage = () => {
  return (
    <section className='relative flex lg:mt-2 mt-[70px]'>
      <div className='container max-w-[1140px] w-screen m-auto flex flex-col-reverse lg:flex-row mt-8 lg:mt-5 lg:mt-18 gap-12 h-[90vh]  '>
        <div className='flex flex-1 flex-col items-center lg:items-start justify-center  mb-[60px] md:max-h-[500px] md:w-[500px]  md:mb-12  lg:mb-0 mt-2'>
          ...
          <div className='flex justify-center mb-2 flex-wrap gap-6 items-center'>
        ...
        <div className='flex  flex-1 flex-col justify-center items-center md:max-h-[500px] md:w-[500px] mb-[30px] md:mb-12  lg:mb-0 mt-2'>
          <img src={BgImage} alt="background" className='w-5/6 h-5/6 sm:w-3/4 sm:h-3/4 md:w-full md:h-full object-cover flex-wrap' />
          <div className='flex'>
